...
def test_plot_logit_lens():
    ...
    plot_logit_lens(
        ...
        test_text="Tuned Lens + Last Layer",
    )
    ...
    plot_logit_lens(
        ...
        add_last_tuned_lens_layer=True,
        topk_diff=True,
        test_text="Topk Prob Diff w/ Last Layer. N/A for bottom row",
    )
    ...
    plot_logit_lens(
        ...
        tuned_lens=pythia_125M_lens,
        topk_diff=True,
        test_text="Topk Prob Diff w/o Last Layer. N/A for bottom row",
    )
